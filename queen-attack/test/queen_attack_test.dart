    ...
    group('Test creation of Queens with valid and invalid positions', () {
      ...
      test('Queens must have positive row value', () {
        expect(
            ...
            throwsA(
              predicate((e) =>
                  e is AssertionError && e.message == 'row not positive'),
            ));
      }, skip: false);
      ...
      test('Queens must have row value on board', () {
        expect(
            ...
            throwsA(
              predicate((e) =>
                  e is AssertionError && e.message == 'row not on board'),
            ));
      }, skip: false);
      ...
      test('Queens must have positive column value', () {
        expect(
            ...
            throwsA(
              predicate((e) =>
                  e is AssertionError && e.message == 'column not positive'),
            ));
      }, skip: false);
      ...
      test('Queens must have column value on board', () {
        expect(
            ...
            throwsA(
              predicate((e) =>
                  e is AssertionError && e.message == 'column not on board'),
            ));
      }, skip: false);
    });
